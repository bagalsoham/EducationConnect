  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.studentCard}>
        <View style={styles.studentInfo}>
          ...
          <View>
            ...
            <Text style={styles.studentClass}>{t("STD Div")}</Text>
            <Text style={styles.studentClass}>{t("Roll Number")}</Text>
          </View>
        </View>
      ...
      <View style={styles.assignmentCard}>
        <Text style={styles.assignmentTitle}>{t("Assignment Pending")}</Text>
        <View style={styles.assignmentContent}>
          <View>
            <Text style={styles.subjectText}>{t("Subject1")}</Text>
            <Text style={styles.dueDate}>{t("Due on")} 12/12/1212</Text>
        ...
        <TouchableOpacity>
          <Text style={styles.viewMore}>{t("View more")}</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.statsContainer}>
        <TouchableOpacity onPress={() => router.push("../overAllAttendance")}>
          <View style={styles.statBox}>
            <Text style={styles.statTitle}>{t("Overall Attendance")}</Text>
            <Text style={styles.statDetails}>
              {t("Conducted till:")} 12/12/1212
            </Text>
        ...
        >
          <Text style={styles.statTitle}>{t("Latest test score")}</Text>
          <Text style={styles.statDetails}>{t("Test date:")} 12/12/1212</Text>
          <Text style={styles.statScore}>60/100</Text>
        </TouchableOpacity>
        <View style={styles.statBox}>
          <Text style={styles.statTitle}>{t("Non Academic Progress")}</Text>
          <FontAwesome
            name="soccer-ball-o"
            size={30}
            color="black"
      ...
      <TouchableOpacity onPress={() => setModalVisible(true)}>
        <Text style={styles.sectionTitle}>{t("Contact Teachers")}</Text>
      </TouchableOpacity>
        ...
        {Array(4)
          ...
          .map((_, index) => (
            <View key={index} style={styles.teacherCard}>
              ...
              <Text style={styles.teacherCardSubject}>
                {t("Subject")} {index + 1}
              </Text>
            </View>
          ))}
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>{t("Contact Teacher")}</Text>

            {/* Call Button */}
            <TouchableOpacity style={styles.modalButton}>
              <Text style={styles.modalButtonText}>📞 {t("Call")}</Text>
            </TouchableOpacity>
            ...
            >
              <Text style={styles.modalButtonText}>💬 {t("Message")}</Text>
            </TouchableOpacity>
