    ...
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => setModalVisible(true)}>
          <Text style={styles.buttonText}>Select Whom to send</Text>
        </TouchableOpacity>
      </View>
              ...
              renderItem={({ item }) => (
                <View style={styles.listItem}>
                  ...
                  <View style={styles.buttonGroup}>
                    <TouchableOpacity style={styles.selectButton}><Text>Select</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.sendButton}><Text>Send</Text></TouchableOpacity>
                  </View>
                </View>
              )}
            />
